...
#define VENUS_STATE_ATTACKED	800

//#define GOOMBA_BBOX_HEIGHT_DIE 9

#define ANI_PIRANA_PLANT 744
#define PIRANA_WIDTH_SAFE 90
...
class PiranaPlant : public CGameObject
{
protected:
...
public:
	...
	PiranaPlant(float x, float y, LPGAMEOBJECT mario);
